    ...
    public function Display($tpl = 'vehicles', $view = 'view')
    {
        ...
        switch ($findType) {
            case 'findByVIN':
                ...
                $requests[] = Oem::findVehicle($vin, $this->getLanguage()->getLocalization());
            ...
            case 'findByFrame':
                ...
                $requests[] = Oem::findVehicle($frameNo, $this->getLanguage()->getLocalization());
            ...
            case 'findByOEM':
                if (!$catalogCode) {
                    ...
                    if ($catalogs->getReferences() && count($catalogs->getReferences())) {
                        ...
                        $amDetails = $this->getAmService()->findOem($oem, '', false, true);
