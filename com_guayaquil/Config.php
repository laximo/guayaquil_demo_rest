...
class Config
{
    ...
    public $oemServiceUrl = 'https://ws.laximo.ru';

    /* aftermarket service url */
    public $amServiceUrl = 'https://aws.laximo.ru';
    ...
    /* show request text and response message */
    ...
    public $backUrl = '/index.php?task=aftermarket&view=findOem&brand=&oem={article}&brand={brand}';
